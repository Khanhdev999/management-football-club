...
<a href="{{url("/players/create")}}" style="margin-left:10%;color:black " class="btn btn-info btn-lg">
        ...
        <thead class="table-light">
            ...
            <tbody class="table-group-divider">
                  ...
                  <tr class="table-primary" >
                    <td>{{$player->name}}</td>
                    <td>
                      <a href="{{url("/players/".$player->id)}}" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span></a>
                      <a href="{{url("/players/".$player->id."/edit")}}" class="btn btn-warning"><span class="glyphicon glyphicon-wrench"></span></a>
